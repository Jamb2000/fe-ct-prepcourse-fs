...
function crearUsuario() {
   ...
   // Retornar la clase.
   // Tu código:
   class Usuario { //aqui se crea la clase. con la variable llamada usuario.
      constructor(usuario, nombre, email, password) {// aqui esta el constructor entre () van lo pedido.
        this.usuario = usuario; 
        this.nombre = nombre;
        this.email = email;
        this.password = password; 
      } // aqui van todas las variables especificadas.
    
      saludar() {  //este es el metodo creado para el saludo
...
function agregarStringInvertida() {
   ...
   // en el ejemplo saldra :  console.log('Hola Mundo'.reverse()); // odnuM aloH
}
